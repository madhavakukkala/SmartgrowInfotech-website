    ...
    <div className="w-full bg-background font-sans md:px-10" ref={containerRef}>
      {(heading || description) && (
        <div className="max-w-7xl mx-auto py-10 px-4 md:px-8 lg:px-10">
          {heading && (
            <h2 className="text-2xl md:text-4xl mb-4 font-bold text-foreground max-w-4xl">
              {heading}
            </h2>
          )}
          {description && (
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-primary via-brand-orange to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
